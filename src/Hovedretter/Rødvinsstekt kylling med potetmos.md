...
1. Kok opp en kjele med lettsaltet vann. Skjær poteter (uskrellet) i 2 cm terninger. Kok
   ...
   Tilsett melk [3 ss | 6 ss], salt [¼ ts | ½ ts] og en klype [[Pepper]]. Mos med en
   gaffel og sett til side under lokk for å holde på varmen.
...
5. Finhakk eller press hvitløk. Varm opp stekepannen til middels varme. Tilsett smør [1
   ...
   | 1 dl] og en klype salt og [[Pepper]]. Kok i 2-3 min. Tilsett evt. kraft fra
   kyllingen i stekepannen. Bland inn kylling.
