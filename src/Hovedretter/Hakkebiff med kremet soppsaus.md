...
5. Senk varmen på stekepannen til lav og tilsett matfløte [1/2 pakke, 2P], soyasaus [1/2
   pakke, 2P], salt [1/4 ts | 1/2 ts] og en stor klype [[Pepper]] med soppen. La småkoke
   til servering, ca. 1-2 min. Rett før servering, tilsett smør [1 ss | 2 ss] til kjelen
   med poteter. Bland godt.
